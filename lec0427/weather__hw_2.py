...
def main():
    filename = "./weather(140)_1970-2022.csv"
    ...
    with open("result.txt", "w", encoding="UTF-8") as fout:
        ...
        submit("양희원", max_rainfalls, f"{max_date[0]}-{max_date[1]:02}-{max_date[2]:02}", max_gap, f"{max_dates[0]}-{max_dates[1]:02}-{max_dates[2]:02}")
        print(f"{max_date[0]}-{max_date[1]:02}-{max_date[2]:02}")

        print("양희원", max_date, max_rainfalls, max_dates, max_gap)
        print("양희원", max_rainfalls, f"{max_date[0]}-{max_date[1]:02}-{max_date[2]:02}", max_gap, f"{max_dates[0]}-{max_dates[1]:02}-{max_dates[2]:02}")
